...
a <- targets::tar_read(imp_ooberror_pm)
targets::tar_config_get("store")
# + use read_csv plutot????? ou une fonction custom pour call le dataset final???
# Or a target?????
...
Below, you may find a summary table of the OOB error for all imputed variables, expressed in the original variable scales (i.e. RMSE): 
