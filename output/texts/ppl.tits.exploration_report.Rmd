...
This document outlines all the important data preparation and exploration steps necessary to enable the evaluation of our research hypotheses. In other words, it presents all **exploratory data analyses** and basic **assumption checks** performed on the *final* version of our dataset. For details regarding the data generation process (i.e. creation of this *final* dataset), readers are referred to the scripts and documents stored at: https://github.com/mrelnoob/ppl.tits. 
