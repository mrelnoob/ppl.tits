...
```{r pm clutchsize scatterF, fig.align='center', fig.cap="**Figure M8a.** Bivariate scatterplot between *Parus major*'s clutch size and each potential connectivity metric", fig.width=12, fig.height=9, message=FALSE, comment=NA, warning=FALSE}
