...
```{r rf4pm r squared plot, fig.align='center', fig.cap="**Figure M1.** Cumulative density function of the Random Forest's $R^{2}_{oob}$ computed over a hundred random repetitions", fig.width=7, fig.height=5, warning=FALSE}
stab_r2plot
```
