...
## 2.2. Models development for the Great tits (*Parus major*)

We built a Random Forest regression model @Breiman2001 using the `randomForest` package 

As spatial interpolation was our goal, we only considered **spatially continuous predictors** in these models.
