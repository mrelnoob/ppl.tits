...
We built a Random Forest regression model [@breiman2001] using the `randomForest` package [@liaw2002]. We used *clutch size* as a response variable and, as spatial interpolation was our goal, we only considered **spatially continuous variables** as predictors: *coord_x*, *coord_y*, *noise_m*, *noise_iq*, *built_area*, *open_area*, *soft_manag_area*, *woodyveg_volume*, *woodyveg_sd*.
