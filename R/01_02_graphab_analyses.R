...
# # I also manually paste my input landcover raster file (lc_dijon_v8_simple.tif), and I tell Git to ignore
# # the Graphab folder altogether because it contains heavy files.
