...
ttCy_comglmm2 <- glmmTMB::glmmTMB(clutch_size ~
                                  ...
                                  data = ntits3, family = glmmTMB::compois(link = "log"),
                                  dispformula = ~1) # Rather long to fit.
summary(ttCy_glm1) # AIC = 1709.9.
summary(ttCy_glmm1) # AIC = 1711.9.
summary(ttCy_comglm1) # AIC = 1402.5.
summary(ttCy_comglmm1) # AIC = 1402.6.
summary(ttCy_comglmm2) # AIC = 1403.7, so the interaction worsen the fit !
...
ttCy_comglmm1ab <- glmmTMB::glmmTMB(clutch_size ~ log_woody_area + log_F_metric_d2b1 + species +
                                   ...
                                   data = ntits3, family = glmmTMB::compois(link = "log"),
                                   dispformula = ~1)
summary(ttCy_comglmm1b) # AIC = 1402 vs 1402.6.
# summary(ttCy_comglmm1ab) # AIC = 1405.2.
...
# summary(ttCy_comglmm1d) # AIC = xxx
# summary(ttCy_comglmm1e) # AIC = xxx
# summary(ttCy_comglmm1f) # AIC = xxx
# summary(ttCy_comglmm1g) # AIC = xxx
# summary(ttCy_comglmm1h) # AIC = xxx
summary(ttCy_comglmm1i) # AIC = 1407.8 vs 1402.6.
summary(ttCy_comglmm1j) # AIC = 1404.
summary(ttCy_comglmm1k) # AIC = 1404.7.
...
summary(ttHSy_glmm1) # AIC = 727.8.
summary(ttHSy_glmm2) # AIC = 728 with the INTERACTION and the MAIN EFFECTS significant (only for F_beta0,
# when F_beta1 is used, than the interaction has p=0.18)!
...
## Using "site" as RE:
ttHSy_glmm1a <- glmmTMB::glmmTMB(brood_size/clutch_size ~ log_woody_area + log_F_metric_d2b1 + species +
                                   urban_intensity + manag_intensity +
                                   light_pollution + noise_m + traffic +
                                   cumdd_30 + year + (1|site),
                                 weights = clutch_size, data = ntits3, family = "binomial")
...
ttHSy_glmm1b <- glmmTMB::glmmTMB(brood_size/clutch_size ~ log_woody_area + log_F_metric_d2b1 + species +
                                 ...
                                 weights = clutch_size, data = ntits3, family = "binomial")
summary(ttHSy_glmm1a) # AIC = 772.3 vs 727.8.
summary(ttHSy_glmm1b) # AIC = 730.
...
ttHSy_glmm1f <- glmmTMB::glmmTMB(brood_size/clutch_size ~ log_woody_area + log_F_metric_d2b1 + species +
                                 ...
                                 weights = clutch_size, data = ntits3, family = "binomial")
summary(ttHSy_glmm1c) # AIC = 726.4 vs 727.8.
summary(ttHSy_glmm1d) # AIC = 723.7.
summary(ttHSy_glmm2d) # AIC = 725.7 and the INTERACTION EFFECT not significant!
summary(ttHSy_glmm1e) # AIC = 726.7.
summary(ttHSy_glmm1f) # AIC = 728.7.
...
## Fitting a regular binomial GLM:
ttFS_bin_glm1 <- stats::glm(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                           clutch_size +
                           urban_intensity + manag_intensity +
                           light_pollution + noise_m + traffic +
                           cumdd_between + year,
...
ttFS_bbin_glm1 <- stats::glm(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                               clutch_size +
                               urban_intensity + manag_intensity +
                               light_pollution + noise_m + traffic +
                               cumdd_between + year,
...
## Fitting a binomial GLMM:
ttFS_bin_glmm1 <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                  clutch_size +
                                  urban_intensity + manag_intensity +
                                  light_pollution + noise_m + traffic +
...
ttFS_bin_glmm1_olre <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                  clutch_size +
                                  urban_intensity + manag_intensity +
                                  light_pollution + noise_m + traffic +
...
ttFS_bbin_glmm1 <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                  clutch_size +
                                  urban_intensity + manag_intensity +
                                  light_pollution + noise_m + traffic +
                                  cumdd_between + year + (1|id_nestbox),
...
ttFS_zibin_glmm1 <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                    clutch_size +
                                    urban_intensity + manag_intensity +
                                    light_pollution + noise_m + traffic +
                                    cumdd_between + year + (1|id_nestbox),
...
ttFS_zibin_glmm1_olre <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                    clutch_size +
                                    urban_intensity + manag_intensity +
                                    light_pollution + noise_m + traffic +
                                    cumdd_between + year + (1|id_obs) + (1|id_nestbox),
...
ttFS_zibbin_glmm1 <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                    clutch_size +
                                    urban_intensity + manag_intensity +
                                    light_pollution + noise_m + traffic +
                                    cumdd_between + year + (1|id_nestbox),
...
ttFS_zibbin_glm1 <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                    clutch_size +
                                    urban_intensity + manag_intensity +
                                    light_pollution + noise_m + traffic +
                                    cumdd_between + year,
...
summary(ttFS_zibbin_glmm2) # AIC = 1376.8 and significant interaction!
summary(ttFS_zibbin_glm2) # AIC = 1374.8 and significant interaction (estimates are similar to the GLMM too)!
...
ttFS_zibbin_glm1b <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_vw + log_F_metric_d2b1 +
                                         clutch_size +
                                         urban_intensity + manag_intensity +
                                         light_pollution + noise_m + traffic +
                                         cumdd_between + year,
...
## Using both:
ttFS_zibbin_glm1c <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                         clutch_size +
                                         urban_intensity + manag_intensity +
                                         light_pollution + noise_m + traffic +
                                         cumdd_between + year,
...
ttFS_zibbin_glm1d <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                        clutch_size +
                                        urban_intensity + manag_intensity +
                                        light_pollution + noise_m + traffic +
...
ttFS_zibbin_glm1e <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                        clutch_size +
                                        urban_intensity + manag_intensity +
                                        light_pollution + noise_m + traffic +
                                        cumdd_between + year,
...
ttFS_zibbin_glm1f <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                        clutch_size +
                                        urban_intensity + manag_intensity +
                                        light_pollution + noise_m + traffic +
                                        cumdd_between + year,
...
ttFS_zibbin_glm1g <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                        clutch_size +
                                        urban_intensity + manag_intensity +
                                        light_pollution + noise_m + traffic +
                                        cumdd_between + year,
...
ttFS_zibbin_glm1h <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                        clutch_size +
                                        urban_intensity + manag_intensity +
                                        light_pollution + noise_m + traffic +
                                        cumdd_between + year,
...
ttFS_zibbin_glmm1h <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                        clutch_size +
                                        urban_intensity + manag_intensity +
                                        light_pollution + noise_m + traffic +
...
ttFS_zibbin_glm1i <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                        clutch_size +
                                        urban_intensity + manag_intensity +
                                        light_pollution + noise_m + traffic +
                                        cumdd_between + year,
...
summary(ttFS_zibbin_glm2h) # AIC = 1362.2 vs 1374.8.
summary(ttFS_zibbin_glmm2h) # AIC = 1364.2.
summary(ttFS_zibbin_glm2i) # AIC = 1366.
...
## Likelihood-based evaluation of effects inclusion:
zzz <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                        clutch_size +
                                        urban_intensity + manag_intensity +
                                        light_pollution + noise_m + traffic +
                                        cumdd_between + year,
                                      ...
                                      family = glmmTMB::betabinomial(link = "logit"),
                                      ziformula = ~1) # Intercept only.
zzz2 <- glmmTMB::glmmTMB(fledgling_nb/brood_size ~ log_woody_area + log_F_metric_d2b1 +
                                            clutch_size +
                                            urban_intensity + manag_intensity +
                                            light_pollution + noise_m + traffic +
...
ttMA_lm1 <- stats::lm(mass ~ log_woody_area + log_F_metric_d2b1 + species + clutch_size +
                         urban_intensity + manag_intensity +
                         light_pollution + noise_m + traffic +
                         cumdd_between + year,
                       data = ntits3)
...
ttMA_lmm1 <- glmmTMB::glmmTMB(mass ~ log_woody_area + log_F_metric_d2b1 + species + clutch_size +
                                 urban_intensity + manag_intensity +
                                 light_pollution + noise_m + traffic +
                                 cumdd_between + year + (1|id_nestbox),
                                data = ntits3, family = "gaussian")
ttMA_lmm1b <- lme4::lmer(mass ~ log_woody_area + log_F_metric_d2b1 + species + clutch_size +
                            urban_intensity + manag_intensity +
                            light_pollution + noise_m + traffic +
...
AIC(ttMA_lm1) # AIC = 1158.9.
summary(ttMA_lmm1) # AIC = 1161.
summary(ttMA_lmm1b) # REML = 1156.1 (not a true AIC).
summary(ttMA_lmm2) # AIC = 1161.2, does not seem supported by the data!
summary(ttMA_lmm2b) # AIC = 1151.9, does not seem supported by the data!
...
xxx %>%
  tidyr::gather(key = "type", value = "residual",
                c(log_woody_area, log_F_metric_d2b1, clutch_size, urban_intensity,
