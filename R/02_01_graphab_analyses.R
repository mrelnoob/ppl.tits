...
# Gilles Vuidel as he needed to create the habitat patches himself in order to extract their pixels
# and compute the weightings for pixels and patches based on the Random Forest model exported by
# the `local_quality_model()` function of {ppl.tits}.
# Consequently, I need only need to load this project:
