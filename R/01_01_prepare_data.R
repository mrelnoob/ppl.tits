...
#' ##################### THERE'S A PROBLEM WITH breeding_window§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
#' ##################### THERE'S A PROBLEM WITH breeding_window§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
#' ##################### THERE'S A PROBLEM WITH breeding_window§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
#' ##################### THERE'S A PROBLEM WITH breeding_window§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
#' ##################### THERE'S A PROBLEM WITH breeding_window§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
...
#' #' `my_iv_data`). The first dataset is the one  while the second is the one that contains
#' #' the "raw" independent variables computed for each nestbox using PostGIS.
...
#' #' read the README file (https://github.com/mrelnoob/ppl.tits).
...
#' #' more "advanced" IVs that will be computed by the next functions to generate the "final" tits
#' #' dataset.
#' #'
#' #' @return A tibble with an improved version of the tits dataset that includes all the "raw"
#' #' @export
