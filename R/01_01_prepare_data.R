...
### Open the table:
tits <- readr::read_csv2(here::here("projects", "pubprivlands", "data", "biological_data", "working_datatables",
                                    "wp_tits", "ppl_dijon_tits_data_20192021.csv"), col_names = TRUE, na = "NA",
                         col_types = readr::cols(id_bird = readr::col_factor(),
                                                 id_ring = readr::col_factor(),
                                                 species = readr::col_factor(),
                                                 year = readr::col_factor(),
                                                 date = readr::col_factor(),
                                                 site = readr::col_factor(),
                                                 id_nestbox = readr::col_factor(),
